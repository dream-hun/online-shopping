...
class CartManagement
{
    ...
    public static function addItemsToCookie($items): void
    {
    ...
    //increase quantity
    public static function increaseQuantity($product_id): void
    {
        $items = self::getCartItems();
        foreach ($items as $key => $item) {
            if ($item['product_id'] == $product_id) {
    ...
    //decrease quantity
    public static function decreaseQuantity($product_id): array
    {
        $items = self::getCartItems();
        foreach ($items as $key => $item) {
            if ($item['product_id'] == $product_id) {
