            ...
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                    ...
                    <div class="bg-white rounded-xl shadow p-4 sm:p-7">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input wire:model='form.client_name' wire:model.blur="form.client_name" class="w-full rounded-lg border  py-2 px-3" placeholder="Ex: John Doe" id="names" type="text">
                                    </input>
                                ...
                                <div>
                                    ...
                                    <input wire:model='form.email' wire:model.blur="form.email" class="w-full rounded-lg border py-2 px-3" id="phone" type="email" placeholder="Ex: mail@yahoo.com">
                                    </input>
                                    @error('form.email')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input wire:model='form.client_phone' wire:model.blur="form.client_phone" class="w-full rounded-lg border py-2 px-3" placeholder="Ex: +250 780 000 000" id="phone" type="text">
                                    </input>
                                ...
                                <div>
                                    ...
                                    <input wire:model='form.shipping_address' wire:model.blur="form.shipping_address"  class="w-full rounded-lg border py-2 px-3" id="phone" type="text" placeholder="Ex: KG 213 ST, REMERA">
                                    </input>
                        ...
                        <div class="mt-2">
                            ...
                            <label for="message" class="block mb-2 font-medium text-gray-900 dark:text-white">Add some notes on the order</label>
                        ...
                        <ul class="grid w-full gap-6 md:grid-cols-2">
                            <li>
                                <input wire:model='form.payment_type' wire:model.blur="form.payment_type" class="hidden peer" id="hosting-small" required="" type="radio" value=" Cash on Delivery" />
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $item['product_id'] }}'>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{ $item['name'] }}" class="w-12 h-12 rounded-full" src="https://iplanet.one/cdn/shop/files/iPhone_15_Pro_Max_green_Titanium_PDP_Image_Position-1__en-IN_1445x.jpg?v=1695435917">
                                        </img>
                                    </div>
