<tr>
    <td class="py-4">
        <div class="flex items-center">
            <img class="h-16 w-16 mr-4 rounded-full"
                ...
                alt="{{ $cartItem->name }}">
            <span class="font-normal">{{ $cartItem->name }}</span>
        </div>
    </td>
    ...
    <td class="py-4">
        <div class="flex items-center">
            ...
            <button class="border border-yellow-400 rounded-full py-2 px-4 mr-2">-</button>
                <span class="text-center w-8">1</span>
            <button class="border border-yellow-400 rounded-full py-2 px-4 ml-2">+</button>
    ...
    <td>
        <button type="button" wire:click="removeFromCart('{{ $cartItem['id'] }}')"
            class="inline-flex items-center text-sm font-medium text-red-600 hover:text-red-900 py-2 px-4 rounded-md border border-red-600">
