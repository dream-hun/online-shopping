                            ...
                            @forelse($categories as $category)
                                <li class="mb-4"
                                    ...
                                    <label for="{{ $category->slug }}" @mouseenter="hover = true"
                                           @mouseleave="hover = false" :class="{ 'bg-gray-50': hover }"
                                        ...
                                        <div class="relative"
                                            ...
                                            <svg
                                                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none text-white transition-all duration-200"
                                                :class="{
