          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr wire:key='{{ $item['product_id'] }}'>
                ...
                <td>
                  <button wire:click='removeItem({{ $item['product_id'] }})' class="bg-red-300 border-2 border-red-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700">
