@php use App\Helpers\Garden; @endphp
        <!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="keywords"
          content="order confirmation, Garden of Eden Produce, organic produce, fresh vegetables, fruits">
            ...
            <div id="printOrder">
                <table class="w-full mb-8">
                    ...
                    <tr>
                        ...
                        <td class="py-2"> {{ Garden::formatPhoneUs($order->client_phone) }}</td>
                    </tr>
                    <tr>
