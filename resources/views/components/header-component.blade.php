            ...
            <div class="flex flex-col sm:flex-row justify-between items-center py-2">
                <div class="flex flex-wrap justify-center sm:justify-start">
                    <a href="tel:{{ $setting->mobile_one }}"
                       class="font-normal px-2 py-1 text-sm">{{ $setting->mobile_one }}</a>
                    <a href="tel:{{ $setting->mobile_two }}"
                       class="font-normal px-2 py-1 text-sm">{{ $setting->mobile_two }}</a>
                    <a href="tel:{{ $setting->whatsapp }}"
                       class="font-normal px-2 py-1 text-sm">{{ $setting->whatsapp }}</a>
                    <a href="mailto:{{ $setting->email_one }}"
                       class="font-normal px-2 py-1 text-sm">{{ $setting->email_one }}</a>
                    <a href="mailto:{{ $setting->email_two }}"
                       class="font-normal px-2 py-1 text-sm">{{ $setting->email_two }}</a>
