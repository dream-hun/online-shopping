...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->uuid]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label class="required" for="measurement">{{ trans('cruds.product.fields.measurement') }}</label>
                <input class="form-control {{ $errors->has('measurement') ? 'is-invalid' : '' }}" type="text" name="measurement" id="measurement" value="{{ old('measurement', $product->measurement) }}" required>
                @if($errors->has('measurement'))
                    <div class="invalid-feedback">
                        {{ $errors->first('measurement') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.measurement_helper') }}</span>
            </div>
            <div class="form-group">
