    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_one') ? 'is-invalid' : '' }}" type="text" name="mobile_one" id="mobile_one" value="{{ old('mobile_one', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_two') ? 'is-invalid' : '' }}" type="text" name="mobile_two" id="mobile_two" value="{{ old('mobile_two', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_one') ? 'is-invalid' : '' }}" type="email" name="email_one" id="email_one" value="{{ old('email_one') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_two') ? 'is-invalid' : '' }}" type="email" name="email_two" id="email_two" value="{{ old('email_two') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_fee') ? 'is-invalid' : '' }}" type="number" name="shipping_fee" id="shipping_fee" value="{{ old('shipping_fee', '') }}" step="1" required>
