        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p><strong>Client Phone:</strong> <?php echo e($order->shipping_address); ?></p>
                    <p><strong>Client Phone:</strong> <?php echo e($order->email); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hunter/Codes/online-shopping/resources/views/admin/orders/show.blade.php ENDPATH**/ ?>