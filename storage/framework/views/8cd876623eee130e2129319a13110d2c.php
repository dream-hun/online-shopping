<div class="isolate py-32">
    <!-- Hero section -->
    <div class="relative isolate -z-10">
        <svg class="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-green-400 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
            aria-hidden="true">
            <defs>
        ...
        <div class="absolute left-1/2 right-0 top-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48"
            aria-hidden="true">
            <div class="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#80ffb5] to-[#1ed60d] opacity-30"
...
<?php /**PATH /home/hunter/Codes/online-shopping/resources/views/livewire/about-component.blade.php ENDPATH**/ ?>