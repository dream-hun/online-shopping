            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Event">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.event.fields.title')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.event.fields.status')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.event.fields.date')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($event->id); ?>">
                            ...
                            <td>
                                <?php echo e(App\Models\Event::STATUS_SELECT[$event->status] ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hunter/Codes/online-shopping/resources/views/admin/events/index.blade.php ENDPATH**/ ?>