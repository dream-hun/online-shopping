    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.products.update", [$product->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('price') ? 'is-invalid' : ''); ?>" type="number" name="price" id="price" value="<?php echo e(old('price', $product->price)); ?>" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('measurement') ? 'is-invalid' : ''); ?>" type="text" name="measurement" id="measurement" value="<?php echo e(old('measurement', $product->measurement)); ?>" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>" name="status" id="status">
                    ...
                    <?php $__currentLoopData = App\Models\Product::STATUS_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(old('status', $product->status) === (string) $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('category') ? 'is-invalid' : ''); ?>" name="category_id" id="category_id" required>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('category_id') ? old('category_id') : $product->category->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>" name="description" id="description" required><?php echo e(old('description', $product->description)); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\minis\Herd\online-shopping\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>