            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.product.fields.measurement')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($product->id); ?>">
                            ...
                            <td>
                                <?php echo e($product->measurement ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e(App\Models\Product::STATUS_SELECT[$product->status] ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\minis\Herd\online-shopping\resources\views/admin/products/index.blade.php ENDPATH**/ ?>