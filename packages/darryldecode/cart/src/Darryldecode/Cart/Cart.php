...
final class Cart
{
     ...
     */
    private $sessionKeyCartItems;

    /**
     * the session key use to persist cart conditions
     */
    private $sessionKeyCartConditions;
     ...
     * @return bool
     */
    private function addRow($id, $item)
    {
     ...
     * @return bool
     */
    private function itemHasConditions($item)
    {
     ...
     * @return mixed
     */
    private function updateQuantityRelative($item, $key, $value)
    {
     ...
     * @return mixed
     */
    private function updateQuantityNotRelative($item, $key, $value)
    {
        $item[$key] = (int) $value;
     ...
     * @return mixed
     */
    private function fireEvent($name, $value = [])
    {
